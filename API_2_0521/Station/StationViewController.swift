...
class StationViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    /* Station datas*/
    var Stations = ["南港":"台北市南港區南港路一段313號","台北":"台北市北平西路3號","板橋":"新北市板橋區縣民大道二段7號","桃園":"桃園市中壢區高鐵北路一段6號","新竹":"新竹縣竹北市高鐵七路6號","苗栗":"苗栗縣後龍鎮高鐵三路268號","台中":"台中市烏日區站區二路8號","彰化":"彰化縣田中鎮站區路二段99號","雲林":"雲林縣虎尾鎮站前東路301號","嘉義":"嘉義縣太保市高鐵西路168號","台南":"台南市歸仁區歸仁大道100號","左營":"高雄市左營區高鐵路105號"]
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        resultName = Stations.keys.filter({ (TempStations) -> Bool in
            let StationTempText: String = TempStations
            return (StationTempText.contains(searchText))
            
        })
        resultAddress = Stations.values.filter({ (TempAddress) -> Bool in
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if(shouldShowResult == true){
            if(resultAddress.count > resultName.count){
